...
type Node interface {
	TokenLiteral() string
	String() string // print AST nodes for debugging/comparison with other AST nodes
}
...
// satisfies the ast.Statement interface so we can add it to the Statements slice of ast.Program
